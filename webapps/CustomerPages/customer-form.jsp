    ...
    <form action="updateCustomer" method="post">
        ...
        <form action="insertCustomer" method="post">
            ...
            <table border="1" cellpadding="5" class="table">
                ...
                <tr>
                    <th>Customer legality: </th>
                    <td>
                        <input type="checkbox" name="legality"
                                onclick="refreshCheckboxValue(this)"
                                <c:if test="${customer.legality == true}">checked value = "true"</c:if>
                                <c:if test="${customer.legality != true}"> value = "false"</c:if>/>
                    </td>
                </tr>
                <tr>
