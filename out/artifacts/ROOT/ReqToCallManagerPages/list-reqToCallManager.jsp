...
<head>
    ...
    <title>Request to call manager Management Application</title>
</head>
<body>
<center>
    ...
    <table border="1" cellpadding="5" class="table">
        ...
        <c:forEach var="reqToCallManager" items="${listReqToCallManager}">
            <tr>
                ...
                <td>
                    <a href="editReqToCallManager?reqToCallManagerId=<c:out value='${reqToCallManager.reqToCallManagerId}' />">Edit</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="deleteReqToCallManager?reqToCallManagerId=<c:out value='${reqToCallManager.reqToCallManagerId}' />">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
