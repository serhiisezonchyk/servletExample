    ...
    <form action="updateSeller" method="post">
        ...
        <form action="insertSeller" method="post">
            ...
            <table border="1" cellpadding="5" class="table">
                ...
                <c:if test="${seller != null}">
                    <input type="hidden" name="sellerId" value="<c:out value='${seller.sellerId}' />" />
                </c:if>
                <tr>
                    <th>Seller name: </th>
                    <td>
                        <input type="text" name="name" size="45"
                               value="<c:out value='${seller.name}' />"
                        />
                    </td>
                </tr>
                <tr>
                    <th>Seller position: </th>
                    <td>
                        <input type="text" name="position" size="45"
                               value="<c:out value='${seller.position}' />"
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="phone" size="15"
                               value="<c:out value='${seller.phone}' />"
                        />
                    </td>
                </tr>
                <tr>
